...
const SignUpEmail = () => {
  return (
    <div id="signup-form-email-container" className="h-full w-full font-monday">
                  ...
                  >
                    ...
                    <div className="submit-button-wrapper large-signup-modal sticky bottom-2 right-0 flex w-[calc(100%+2px)] justify-end">
                      <div className="account-setup-desktop-questions-submit-button-component large-signup-modal mt-[auto] flex items-center justify-end font-monday">
                        <button
                          type="button"
                          className=" submit-button button_2cc9b456c1 sizeMedium_18a78b4558  kindPrimary_873cf6047e colorPrimary_5d4dbadec9 inline-flex h-10 min-w-[auto] cursor-pointer select-none items-center justify-center whitespace-nowrap rounded-[4px] bg-[var(--primary-color)] px-4 py-2 text-base font-normal antialiased text-white opacity-90 transition-[min-width] hover:bg-[var(--primary-hover-color)]"
                          tabIndex={0}
                          data-testid="button"
                          aria-disabled="false"
                          aria-busy="false"
